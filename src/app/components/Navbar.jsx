...
import { faChild, faEnvelope, faHome, faPaw, faPhone, } from "@fortawesome/free-solid-svg-icons";
import { faFacebook, faInstagram, faLinkedin, faWhatsapp,faLinkedinIn } from '@fortawesome/free-brands-svg-icons';

const Navbar = () => {
  return (<nav className='flex justify-between items-center bg-zinc-800 px-8 py-3 w-full md:w-full'>
    <Link className='text-white font-bold hover:scale-110 transition ease-in-out duration-300 ' href={"/"}><FontAwesomeIcon icon={faHome}/></Link> 
